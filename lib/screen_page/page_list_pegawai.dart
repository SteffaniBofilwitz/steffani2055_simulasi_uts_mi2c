...
import 'package:simulasi_uts/screen_page/page_bottom_navigation.dart';
import 'package:simulasi_uts/screen_page/page_edit_pegawai.dart';
import 'package:simulasi_uts/screen_page/page_login_api.dart';
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
          Uri.parse("http://10.126.159.105/edukasi_server/getPegawai.php"));
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          ...
                                          http.post(
                                            Uri.parse('http://10.126.159.105/edukasi_server/deletePegawai.php'),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (keyForm.currentState?.validate() == true) {
                      ...
                      http.post(
                        Uri.parse('http://10.126.159.105/edukasi_server/simpanPegawai.php'),
                        body: dataKaryawan,
                      ).then((response) {
                        // Memeriksa respons dari server
                        if (response.statusCode == 200) {
